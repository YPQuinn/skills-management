...
export function SourceFacts({ source }: { source: SourceDetail }) {
  ...
  return (
    <div className="space-y-2 text-xs">
      ...
      <Collapsible>
        <CollapsibleTrigger className="group inline-flex items-center gap-1 text-foreground-subtle underline decoration-border underline-offset-2 transition-colors hover:text-foreground hover:decoration-foreground">
